// ========================================
// PÁGINA COMPLETA DE ADMIN DE TRABAJOS PRÁCTICOS
// ========================================
...
export default function Profesor() {
  ...
  // 🔄 CARGAR DATOS - Trabajos y estadísticas
  const fetchData = async () => {
    try {
      ...
      // 👥 Obtener perfiles de usuarios para los trabajos
  ...
  const handleApproveAssignment = async (assignmentId: string, action: 'approved' | 'rejected') => {
    ...
    try {
      ...
      // 💾 Actualizar assignment en la base de datos
      ...
      // 📧 Enviar email al alumno si se aprueba
      if (action === 'approved') {
