-- ===================================================
-- ARREGLAR RELACIONES SIN ASSUMIR ESTRUCTURA
-- ===================================================

-- 1. Crear programa por defecto (solo con campos básicos)
INSERT INTO programs (id, title, slug, created_at, updated_at)
VALUES (
...
-- 2. Crear curso por defecto (solo con campos básicos)
